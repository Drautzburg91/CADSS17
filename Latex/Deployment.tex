...
Deployment für Webapplikation
Heroku deployed den Code des angegebenen Github-Branches, commits werden erkannt und es wird neu deployed.
Gegen Bezahlung ist eine automatische Skalierung aktivierbar.
