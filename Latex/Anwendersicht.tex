...
Beispielsweise übersetzt die Klasse \textbf{Uebersetzung} die verschiedenen Wettercodes in, für den Anwender lesbare, Wetterbezeichnungen. Dies geschieht mit Hilfe einer einfachen Switch-Case-Anweisung, wie exemplarisch in Abb. \ref{Case-Uebersetzung} zu sehen.
  \begin{lstlisting}[captionpos=b, caption={Switch Case zur Übersetzung der Warn-IDs}\label{Case-Uebersetzungen}]
 switch (code) {
            case "H1": {
...
\begin{table}[!ht]
  \centering
    \begin{minipage}{17cm}
     ...
     \hline
      \end{tabular}
   \caption{Validierung des Webclient nach "12 Faktor App"}\label{tab:AnforderungenWebclient}
    \end{minipage}
\end{table}
\newpage
\begin{table}[!ht]
