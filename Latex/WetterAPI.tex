...
Für den Zugriff und die Abfrage der „OpenWeatherMap“- API wurde ein Service mit der Klasse „WeatherDataService“ implementiert, welcher die Abfrage regelt und ein Json mit der gewünschten Struktur zurückliefert. Dieses Json wird dann mit Hilfe von "Mqtt" an die MoM gepublished. 

In diesem Abschnitt wird der Aufbau dieser Klasse „WeatherDataService“ kurz beschrieben, gefolgt von einer Beschreibung der wichtigsten Methoden. 

Grundlegend regelt die Klasse die Kommunikation und den Nachrichtenfluss zwischen „OpenWeatherMap“ und der MoM. 
...
\item["public void dailyToWeatherData"] liest den von der Methode "handlePLZtoday" gestellten HTTP-Request aus und zieht die gewünschten Daten anhand der Struktur der Klasse "WeatherData" aus dem Response-Json der "OpenWeatherMap"-API. Anschließend wird a die gewünschte Json-Struktur zusammengebaut. 
\item["public void handlePLZWeekly(String plz, String countryCode)"]
\item["public static WeatherData dailyToWeatherData(JsonElement root, String plz)"]
\item["public static ArrayList<WeatherDataWeekly> weeklyToWeatherDataWeekly(JsonElement root, String plz)"]
\item["private void reconnectToMoM()"]
