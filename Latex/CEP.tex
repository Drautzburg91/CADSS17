\chapter{Complex Event Process}\label{cep}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{Bilder/MoMKopmponents.png}
  ...
  \centering
    \begin{minipage}{15cm}
     ...
     1.&Codebase&Andere Komponenten sind nur für das Testszenario da. Deployment verschiederner Versionen über Repo möglich&Ja\\
      \hline
     2.&Abhängigkeiten&Abhängigkeiten werden über Gradle verwaltet&Ja\\
     \hline
