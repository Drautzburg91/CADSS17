 ...
 * 	Endpoint IP:				cad-weather-api-database.cc1ormgk3ins.us-east-2.rds.amazonaws.com	
 * 
 * Default AWS Connection Strings
 *	default_connection			"jdbc:mysql://cad-weather-api-database.cc1ormgk3ins.us-east-2.rds.amazonaws.com:3306/WeatherSystemDatabase,CAD_MASTER_JDBC,HTWGhtwg";
 *	
 *
 * 
 * ####################################################################################################################################
 ...
 * [GENERAL]
 * 		1) Constructor
 * 				Arguments: SQL Connection Object
 * 						   pass NULL Object to create and use default connection to AWS RDS Service
 * 
 ...
 *
 *		5) insert_Alert(int ZipCode, Timestamp timestamp, String title, String code, String message)
 *  
 *  	6) insert_Weather(Timestamp TimeStamp, int ZipCode, int WeatherID, 
...
//Variables&Refernces	
	java.sql.Connection  default_connection = null;


//[GENERAL]
//--Constructor	
	public CAD_WEATHER_SYSTEM_DATABASE_API(java.sql.Connection  database_connection)
	{
		this.default_connection = database_connection;	
		if(default_connection == null)
		{
			this.default_connection = connect_default_connection();
		}
	...
	//Default Connection 
			private java.sql.Connection connect_default_connection()
			{
		...
		//Check Connection
			public String check_database_connection()
			{
			    ...
			    try {
			    	isConnected = default_connection.isValid(5);
...
//INSERT MYSQL Operations
	//DefaultWeather Table
		public String insert_DefaultWeather(int WeatherID, String main, String description, String icon_referenz)
		{
			...
			//MYSQL Query 
				...
				try 
				{
					statement = (Statement) default_connection.createStatement();	
	...
	//City Table
		public String insert_City(int ZipCode, String cityName, Double logitude, Double latitude, int cityID)
		{
			//Check Incoming Data
				if(ZipCode <= 0)
				{
	...
	//Alert
			public String insert_Alert(int ZipCode, Timestamp timestamp, String title, String code, String message)
			{
				//Check Incoming Data
				if(ZipCode <= 0)
				{
				...
				//MYSQL Query 
					...
					try 
					{
						...
						query = "INSERT INTO " + 
						        ...
						        "VALUES"+
								"('"+ZipCode+"','"+timestamp+"','"+title+"','"+message+"');";	//Values for Insert
...
//Insert MYSQL Operations
	...
	//Assigned
		public String insert_Assigned(String systemUser_userName, String vHost_name, String additionalInformation, String readRights, String writeRights, String configureRights)
		{
			//Check Incoming Data
				...
				if( !(readRights.toUpperCase().equals("TRUE")) || !(readRights.toUpperCase().equals("FALSE")) )
				{
					return ("Attribute readRights should be TRUE or FALSE");
				}
				
				if( !(writeRights.toUpperCase().equals("TRUE")) || !(writeRights.toUpperCase().equals("FALSE")) )
				{
					return ("Attribute writeRights should be TRUE or FALSE");
				}
				
				if( !(configureRights.toUpperCase().equals("TRUE")) || !(configureRights.toUpperCase().equals("FALSE")) )
				{
					return ("Attribute configureRights should be TRUE or FALSE");
				}
